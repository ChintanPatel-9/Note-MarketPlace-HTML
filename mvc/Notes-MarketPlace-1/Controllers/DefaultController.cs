    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (SqlConnection conn = new SqlConnection())
            {
                ...
                conn.ConnectionString = "Server=[DESKTOP-5RS37T2];Database=[NoteMarketplace-1];Trusted_Connection=true";
                conn.Open();
                // Create the command  
                ...
                SqlCommand insertCommand = new SqlCommand("INSERT INTO Countries ('ID','Name','CountryCode','CreatedDate','ModifiedDate','ModifiedBy','IsActive') VALUES (1,'1',1,'2020-11-1',1,'2020-1-2',1,1)", conn);
                ...
                try
                {
                    ...
                    SqlCommand errorCommand = new SqlCommand("SELECT * FROM Countries", conn);
